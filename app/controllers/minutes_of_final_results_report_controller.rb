class MinutesOfFinalResultsReportController < ApplicationController
  ...
  def form
    ...
    @course = Course.where( id: Grade.where( id: ClassroomsGrade.find_by( classroom_id: @minutes_of_final_results_report_form.classroom_id ).grade_id ).first.course_id ).first
    fetch_collections
  end
